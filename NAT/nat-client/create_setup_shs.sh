...
echo route add -net $CLIENT1_IP netmask 255.255.240.0 gw $NAT1_IP eth0 >> setup1/setup.sh
...
echo route add -net $CLIENT2_IP netmask 255.255.240.0 gw $NAT2_IP eth0 >> setup2/setup.sh
